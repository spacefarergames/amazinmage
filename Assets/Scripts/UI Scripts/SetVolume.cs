...
public class SetVolume : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        musicSlider.value = FBPP.GetFloat("MusicVolume", .25f);
        effectSlider.value = FBPP.GetFloat("EffectVolume", .25f);
    ...
    public void MusicLevel(float sliderValue)
    {
        ...
        FBPP.SetFloat("MusicVolume", sliderValue);
    }
    ...
    public void EffectLevel(float sliderValue)
    {
        ...
        FBPP.SetFloat("EffectVolume", sliderValue);
    }
}
